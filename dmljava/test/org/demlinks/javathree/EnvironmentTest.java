...
public class EnvironmentTest {
	...
	public void testLinkTo() throws Exception {
		...
		assertTrue(env.isLinkForward(new Id("a"), new Id("b")));//working is the king of war
	...
	public void parseTree(Id nodeID, int downToLevel, String whatWas) {//TODO parser
		...
		NodeParser parser = env.getParser(nodeID, List.FORWARD, Location.FIRST);
		//NodeParser parser = env.getParser(nodeID, List.FORWARD, Location.AFTER, null);
