...
public class EnvironmentTest {
	...
	public void testLink() throws Exception {
		...
		Node_L0 _a = env.getNode("a");//get the Node object who's ID is "a"
		Node_L0 _b = env.getNode("b");
		assertTrue(null != _a);
		assertTrue(null != _b);
...
//		chi.remove("B");
	...
	public void addAllChars() throws Exception {
		Node_L0 _a = env.getNode("AllChars");
		for (int i = 65; i < 72; i++) {
	...
	public void testUnMappedNode() throws Exception {
		...
		env.link("a","b");
		Node_L0 _a = env.getNode("a");
		//Node _b = env.getNode("b");
		
		Node_L0 _boo = new Node_L0();//a node that's not mapped ID to Node in the environment
...
//		assertTrue(env.isLink("boo", _b));
	...
	public void testNullParameters() throws Exception {
		...
		String nullStr = null;
		Node_L0 nullNode = null;
		String fullStr = "something";
		Node_L0 fullNode = new Node_L0();
		
		boolean excepted=false;
		
		try {
			env.link("a", new Node_L0());
		} catch (Error e) {
			excepted = true;
		}
		assertTrue(excepted);
