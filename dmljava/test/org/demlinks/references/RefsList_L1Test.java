...
public class RefsList_L1Test {
	RefsList_L1<Object> refList;
	Object obj1, obj2;
	Reference<Object> ref1, ref2;

	@Before
	public void init() {
		refList = new RefsList_L1<Object>();
		obj1 = new Object();
		obj2 = new Object();
	...
	public void something() throws Exception {
		...
		assertTrue(refList.getNodeRefAt(Location.FIRST) == refList
				.getFirstRef());
		assertTrue(refList.getNodeRefAt(Location.LAST) == refList.getLastRef());
		assertTrue(refList.getNodeRefAt(Location.AFTER, ref1) == ref2);
		assertTrue(refList.getNodeRefAt(Location.BEFORE, ref2) == ref1);
		assertFalse(mod != refList.getModified());
