...
<?
        ...
        if (!terminal) { //this should stop you from running the autogenerated code if it's older than this source! but if other files than main.php get modified they won't be sensed!
                echo $_SERVER['PHP_SELF'];
                _tIFnot( $selfstat=stat('/home/emacs/won/demlinks/trunk/php_pdo_base/'.__FILE__) );//$_SERVER['PHP_SELF']);
                $selfstat=$selfstat['mtime'];
                _tIFnot( $autostat=stat('index.php') );
                $autostat=$autostat['mtime'];
                _tIF($selfstat > $autostat );
        }
