...
public class Reference<Obj> {
	...
	// clone constructor
	public Reference( final Reference<Obj> cloneThis ) {
		
		this.initAsDead();
		assert null != cloneThis;
	...
	public boolean equals( final Reference<Obj> compareObj ) {
		
		if ( ( this.prev == compareObj.prev ) && ( this.next == compareObj.next ) && ( this.object == compareObj.object ) ) {
			return true;
		}
		return false;
	...
	public void setObject( final Obj toObject ) {// even if null
	...
	public void setPrev( final Reference<Obj> prevRef ) {
	...
	public void setNext( final Reference<Obj> nextRef ) {
