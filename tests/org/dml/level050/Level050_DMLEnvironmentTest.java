...
public class Level050_DMLEnvironmentTest
{
			...
			test1()
	{
		...
		assertTrue( node2.remove(
									NodeType.CHILD,
									Position.AFTER,
									new3 ) == new4 );
		assertFalse( node2.has(
								NodeType.CHILD,
								new4 ) );
		assertTrue( node2.get(
								NodeType.CHILD,
