...
@Suite.SuiteClasses( value = {
		AllTestsReferences.class, AllTestsReferencesMethod.class, AllTestsTools.class, AllTestsDatabase.class,
		AllTestsL010.class, AllTestsL020.class, AllTestsL025.class, AllTestsL030.class, AllTestsL040.class,
		AllTestsL050.class
} )
