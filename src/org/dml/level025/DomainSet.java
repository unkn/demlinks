...
public class DomainSet extends SetOfTerminalSymbols {
	...
	private final static void registerDSInstance( Level025_DMLEnvironment env, Symbol self, DomainSet newOne ) {

		RunTime.assumedNotNull( env, self, newOne );
		RunTime.assumedFalse( allDomainSetInstances.ensure( env, self, newOne ) );
	}
	
	private final static DomainSet getDSInstance( Level025_DMLEnvironment env, Symbol self ) {
