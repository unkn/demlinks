 ...
 */
public class Level020_DMLStorage_BerkeleyDB extends Level010_DMLStorage_BerkeleyDB implements
	...
	@Override
	public boolean ensureVector( Symbol initialNode, Symbol terminalNode ) throws StorageException {
	...
	public BDBVectorIterator<Symbol, Symbol> getIterator_on_Initials_of( Symbol terminalObject ) {
		...
		try {
			return bdb.getDBMapSymbolsTuple().getIterator_on_Initials_of( terminalObject );
		} catch ( DatabaseException de ) {
			throw new StorageException( de );
		}
	}
	...
	public BDBVectorIterator<Symbol, Symbol> getIterator_on_Terminals_of( Symbol initialObject ) {
		...
		try {
			return bdb.getDBMapSymbolsTuple().getIterator_on_Terminals_of( initialObject );
		} catch ( DatabaseException de ) {
			throw new StorageException( de );
		}
	}
	...
	public Symbol findCommonTerminalForInitials( Symbol initial1, Symbol initial2 ) {
		...
		try {
			return bdb.getDBMapSymbolsTuple().findCommonTerminalForInitials( initial1, initial2 );
		} catch ( DatabaseException de ) {
			throw new StorageException( de );
		}
	}
