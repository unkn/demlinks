;FIXME: this is autoloaded by ccw when the option "Automatic namespaces load on start and on save" is enabled; regardless of which ns you load in repl at start (Ctrl+Alt+L)
#_(ns random.learning.seesaw.seesaw-repl-tutorial)
